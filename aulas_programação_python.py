...
Original file is located at
    https://colab.research.google.com/drive/1kKqK97EzgqRO5OM5NxfMjU6ivJApxyJB
...
from traitlets.config import subcommand_description
from pygments.token import Name
#1. crie um sistema que some 2 números:
...
# nome_do_usuário = input('Digite o seu nome: ')
# print('nome_do_usuário')

#3.crie um sistema que imprime seu nome na tela e um comprimento após seu nome (concatenar)
# nome_do_usuário = input('Digite o seu nome: ')
# text = 'Oi'
# print(text , nome_do_usuario)
...
# # declare uma variavel de número inteiro e verifique se ele é maior que 10
# n1 = 10
# if n1 < 100:
...
# 1. 45 e 18
# n1 = int(input(' digite o número '))        #n1 = 45    VÊ DPS EM CASA
# n2 = int(input('digite o número '))         #n2 = 18
...
# if nota1 and nota2 and nota3 >= 7 :
#    print('Acesso Autorizado')
# else:
#   print("Acesso Negado")


#Crie duas váriaveis para armazenar seu primeiro nome e sobrenome. Em seguida, concatene-as para formar seu nome completo e exiba o resultado:

# nome_do_usuario = input('Digite o seu nome: ')
# nome_do_usuario2 = input('Digite o seu sobrenome: ')
# print(nome_do_usuario , nome_do_usuario2)


#Crie um programa para eftuar a leitura de um número inteiro e apresentar o resultado do quadrado deste número.
...
#peça ao usuario para digitar dois números inteiros e armazene-os em variáveis. Realize a concatenação desses números
#como string e exiba o resultado
...
#Declare uma variável contendo uma frase. Em seguida, peça ao usuário para digitar uma palavra e concatene essa palavra
#no final da frase. Exiba o resultado
# text: input('Pegue essa ')


#Declare duas variaveis com numeros de telefone, incluindo um codigo de area e o número principal. Concatene esses
#valores para formar um número de telefone completo.
...
#Crie uma lista de ingredientes para uma receita. Use concatenação para formar uma unica string que liste os
#ingredientes por vírgulas.
...
#????????????? Peca ao usuario para digitar tres adjetivos e armazene-os em variaveis. Em seguida, use essas palavras para criar uma frase concatenada que descreve algo.
# num = input('Digite um adjetivo: ')
# num1 = input('Digite um adjetivo: ')
# num2 = input('Digite um adjetivo: ')

# print('Ele é um homem' , num , num1 , num2)




#CRIE UMA VARIAVEL PARA ARMAZENAR A PALAVRA PYTHON. Em seguida, adicione um número inteiro ao final da palavra usando a concatenção.
...
# n1 = 10
# n2 = 30
# print(f'numero 1 - {n1} e numero 2 - {n2}')


#EXERCÍCIOS:   NÃO FOI FÁCIL

#1. Escreva um programa em Python que solicite ao usuário um número inteiro e verifique se o número é positivo, negativo ou zero.
#Em seguida, exiba uma mensagem apropriada de acordo com o resultado da verificação.
...
#2. Escreva um programa em Python que receba três comprimentos de lados de um triângulo e determine se o triângulo é equilátero, isósceles ou escaleno.

# comp1 = int(input('Digite o comprimento do triangulo: '))
# comp2 = int(input('Digite o comprimento do triangulo: '))
# comp3 = int(input('Digite o comprimento do triangulo: '))
...
#3. Um ano é bissexto se for divisível por 4, exceto para anos que são divisíveis por 100. No entanto, anos divisíveis por 400 também são bissextos. Escreva um programa em Python que
#solicite um ano ao usuário e determine se é um ano bissexto ou não.

# name = int(input('digite um ano bissexto: '))
# if name % 4 == 0 :
#  print('Ano bissexto')
# else:
...
# texto = "Python"
# comprimento = len(texto)  # Isso irá retornar 6 print, pq são 6 caracteres
...
#type(): Retorna o tipo de um objeto/dado.
#Isso irá retornar <class 'int'> de inteiros
...
# int(), float(), str(): Usados para converter valores de um tipo para outro.
# numero = int("42")    # Converte uma string para um número inteiro
# texto = str(3.14)     # Converte um número de ponto flutuante para uma string
...
# list(), tuple(): Usados para converter uma sequência (como uma string) em uma lista ou tupla.
# texto = "Python"
# lista = list(texto)   # Converte a string em uma lista ['P', 'y', 't', 'h', 'o', 'n']
...
# numeros = range(1, 6)  # Cria uma sequência de 1 a 5


#...........................................................

# sum(): Calcula a soma dos elementos em uma sequência, como uma lista.
# numeros = [1, 2, 3, 4, 5]
...
# minimo = min(numeros)  # Isso irá retornar 1
# maximo = max(numeros)  # Isso irá retornar 9
...
#loop for :  evita digitar muitas vezes um algoritmo
...
#Iterando por uma Lista de Listas:
...
# n = input('Digite o seu user: ')
# print('Olá' , n , ', como vai?')
